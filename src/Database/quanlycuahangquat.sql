...
CREATE TABLE `chitiet_phieunhap` (
  ...
  CONSTRAINT fk_ctpn_quat FOREIGN KEY (`MaQuat`)
    REFERENCES `quat`(`MaQuat`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `hoadon` (
  ...
  CONSTRAINT fk_hd_nv FOREIGN KEY (`MaNhanVien`)
    REFERENCES `nhanvien`(`MaNhanVien`),
  CONSTRAINT fk_hd_sk FOREIGN KEY (`MaSKKhuyenMai`)
    REFERENCES `su_kien_khuyen_mai`(`MaSKKhuyenMai`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `chitiet_hoadon` (
  ...
  CONSTRAINT fk_cthd_quat FOREIGN KEY (`MaQuat`)
    REFERENCES `quat`(`MaQuat`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `quanlibaohanh` (
  ...
  CONSTRAINT fk_qbh_quat FOREIGN KEY (`MaQuat`)
    REFERENCES `quat`(`MaQuat`),
  CONSTRAINT fk_qbh_kh FOREIGN KEY (`MaKhachHang`)
    REFERENCES `khachhang`(`MaKhachHang`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
