...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 14, 2025 lúc 08:27 AM
...
INSERT INTO `khachhang` (`MaKhachHang`, `HoTenKH`, `Sdt_KH`, `DiaChiKH`, `TongTienDaMua`, `TrangThai`) VALUES
('KH001', 'Nguyễn Văn A', '0912345678', 'Hà Nội', 27110000, 1),
('KH002', 'Trần Thị B', '0987654321', 'TP.HCM', 2850000, 1),
('KH003', 'Lê Văn C', '0933221144', 'Đà Nẵng', 5400000, 1),
('KH004', 'Trần Văn Bảo', '0914234567', 'TP.HCM', 5410000, 1),
('KH005', 'Lê Thị Hồng', '0925345678', 'Đà Nẵng', 2000000, 1),
('KH006', 'Phạm Văn Minh', '0936456789', 'Hải Phòng', 950000, 1),
('KH007', 'Đỗ Thị Thủy', '0947567890', 'Cần Thơ', 6280000, 1),
('KH008', 'Hoàng Văn Long', '0958678901', 'Huế', 4700000, 1),
('KH009', 'Ngô Thị Hương', '0969789012', 'Bình Dương', 3000000, 1),
('KH010', 'Bùi Văn Hùng', '0970890123', 'Biên Hòa', 700000, 1),
('KH011', 'Dương Thị Lan', '0981901234', 'Quảng Ninh', 1600000, 1),
('KH012', 'Trịnh Văn Sơn', '0992012345', 'Lâm Đồng', 1300000, 1),
('KH013', 'Cao Thị Yến', '0903123456', 'Hưng Yên', 1750000, 1),
('KH014', 'Tạ Văn Phúc', '0914234561', 'Thái Bình', 900000, 1),
('KH015', 'Phan Thị Nga', '0925345672', 'Nam Định', 1950000, 1);
...
('LSP01', 'Quạt trần', 'Hoạt động', 'Quạt gắn trên trần, tiết kiệm không gian'),
('LSP02', 'Quạt đứng', 'Hoạt động', 'Quạt có chân đế điều chỉnh chiều cao'),
('LSP03', 'Quạt bàn', 'Hoạt động', 'Quạt nhỏ gọn đặt trên bàn làm việc.'),
('LSP04', 'Quạt hộp', 'Hoạt động', 'Quạt hình hộp, thiết kế an toàn cho trẻ em'),
('LSP05', 'Quạt sạc', 'Hoạt động', 'Quạt dùng pin sạc, tiện lợi khi mất điện');
...
('PN016', '2025-05-07', 'NCC001', 'NV001', 10);
...
('Q001', 'Quạt Toshiba Remote', 550000, 23, 'NSX003', '2024-03-01', 'Nhựa cao cấp', 'Toshiba', 'LSP02'),
('Q002', 'Quạt Midea ', 650000, 36, 'NSX002', '2024-03-15', 'Kim loại + nhựa', 'Midea', 'LSP02'),
('Q003', 'Quạt mini Panasonic', 350000, 57, 'NSX001', '2024-02-20', 'Nhựa ABS', 'Panasonic', 'LSP03'),
('Q004', 'Quạt Toshiba', 470000, 54, 'NSX004', '2023-04-12', 'Nhựa cứng', 'Toshiba', 'LSP03'),
('Q005', 'Quạt Samsung', 1250000, 27, 'NSX005', '2023-02-05', 'Nhựa', 'Samsung', 'LSP03'),
('Q006', 'Quạt LG', 2200000, 36, 'NSX006', '2023-01-25', 'Hợp kim', 'LG', 'LSP03'),
('Q007', 'Quạt Mini Sony', 250000, 32, 'NSX007', '2023-07-18', 'Nhựa mềm', 'Sony', 'LSP04'),
('Q008', 'Quạt Hitachi', 980000, 38, 'NSX008', '2023-08-08', 'Nhựa', 'Hitachi', 'LSP01'),
('Q009', 'Quạt Sharp', 560000, 75, 'NSX009', '2023-09-01', 'Kim loại', 'Sharp', 'LSP02'),
('Q010', 'Quạt Daikin', 3600000, 50, 'NSX010', '2023-07-10', 'Thép', 'Daikin', 'LSP05'),
('Q011', 'Quạt Electrolux', 750000, 67, 'NSX011', '2023-03-23', 'Nhựa', 'Electrolux', 'LSP04'),
('Q012', 'Quạt Aqua', 410000, 57, 'NSX012', '2023-05-30', 'Nhôm', 'Aqua', 'LSP01'),
('Q013', 'Quạt Kangaroo', 620000, 34, 'NSX013', '2023-06-06', 'Nhựa', 'Kangaroo', 'LSP01'),
('Q014', 'Quạt Sanaky', 2400000, 56, 'NSX014', '2023-01-11', 'Kim loại', 'Sanaky', 'LSP03'),
('Q015', 'Quạt BlueStone', 490000, 40, 'NSX015', '2023-04-22', 'Nhựa', 'BlueStone', 'LSP02'),
('Q016', 'Tefan 5 cánh', 400000, 23, 'NSX001', '2025-04-21', 'Nhựa', 'Tefan', 'LSP01'),
('Q017', 'Senco', 500000, 23, 'NSX001', '2025-05-02', 'Kim Loại', 'Senco', 'LSP01'),
('Q018', 'Panasonic 4 cánh', 400000, 20, 'NSX001', '2025-05-01', 'Nhựa', 'Panasonic', 'LSP02'),
('Q019', 'Quạt Asia 2', 550000, 20, 'NSX001', '2024-03-12', 'Nhựa', 'Asia', 'LSP01'),
('Q020', 'Quạt Senko TR828', 420000, 15, 'NSX002', '2024-04-05', 'Kim loại', 'Senko', 'LSP02'),
('Q021', 'Quạt Midea FT30', 380000, 30, 'NSX003', '2024-02-22', 'Nhựa', 'Midea', 'LSP01');
